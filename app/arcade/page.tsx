...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Fairbyte Arcade", description: "Eleven browser games, including five re-coded classics. No downloads. Pick a world and play.", type: "website", url: "/", siteName: "Fairbyte Arcade", images: [{ url: "/arcade/room-404-cover.jpg", width: 1672, height: 941, alt: "Fairbyte Arcade game catalog" }] },
